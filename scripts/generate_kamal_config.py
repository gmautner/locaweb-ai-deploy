...
Reads from files:
  ...
  /tmp/kamal_custom_vars.json     - KAMAL_-prefixed custom clear vars
  /tmp/kamal_custom_secrets.json  - KAMAL_-prefixed custom secret names
...
# Merge KAMAL_-prefixed custom variables and secrets
